 ...
 */
public class Frm_ERuidov2 extends javax.swing.JDialog {

    /**
     * Creates new form Frm_ERuidov2
     */
    NoReiniciable nrei;
    ...
    public Frm_ERuidov2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public Frm_ERuidov2(java.awt.Frame parent, boolean modal, int idVehiculo,
    ...
    private void initComponents() {
        ...
        setTitle("Elementos para producir ruido");

        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(""));

        jPanel7.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        jCheckBox1.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        jCheckBox1.setText("<html>La existencia de algún tipo de dispositivo o accesorio diseñado para producir ruido, <br/>tales como vávulas, cornetas y pitos adaptados a los sistemas de bajo y de frenos de aire</html>");

        jCheckBox2.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        jCheckBox2.setText("Ausencia o defectos como perforaciones no originales o fisuras de los sistemas de salida de gases");

        jCheckBox3.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        jCheckBox3.setText("Presencia de resonadores en el sistema de escape de gases");
        ...
        jTabbedPane1.addTab("Dispositivos sonoros no permitidos", new javax.swing.ImageIcon(getClass().getResource("/com/soltelec/Icon/app_24.png")), jPanel7); // NOI18N

        jCheckBox4.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        jCheckBox4.setText("El no funcionamiento de la bocina, pito o dispositivo acústico");
        ...
        jTabbedPane1.addTab("Bocina, pito dispositivo acústico", new javax.swing.ImageIcon(getClass().getResource("/com/soltelec/Icon/sound_24.png")), jPanel1); // NOI18N

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/soltelec/Icon/solt.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Serif", 1, 36)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("<html><center>ELEMENTOS PARA<br/> PRODUCIR RUIDO</center></html>");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/soltelec/Icon/bocina.png"))); // NOI18N
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        establecerGrupo("Elementos para producir ruido");
        ...
        if (persistir == true) {
            try {
                ...
                conexion.close();
                 JOptionPane.showMessageDialog(this, "Se ha REGISTRADO los Defectos (Elementos para producir Ruido) de una Manera Exitosa ");
            } catch (SQLException ex) {
                Mensajes.mostrarExcepcion(ex);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frm_ERuidov2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                Frm_ERuidov2 dialog = new Frm_ERuidov2(new javax.swing.JFrame(), true);
