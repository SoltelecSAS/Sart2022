 ...
 */
public class FrmProfundidadLabradoMoto extends javax.swing.JDialog {
    ...
    public FrmProfundidadLabradoMoto(java.awt.Frame frame, boolean modal, int idVehiculo, int hojaPruebasActual, int idPrueba, int idUsuario, Vehiculos vehiculo,EntityManager em) {
        super(frame, modal);
        ...
        if (!txtLabrado.equalsIgnoreCase("0")) {
            ...
            txtLLantaInz1.setText(eje);          
            eje =  lstEjes[1].replace("$", "");
            infLabr = eje.split("-");
            txtLLantaIzq2.setText(eje);           
        this.frame = frame;
    ...
    public FrmProfundidadLabradoMoto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
        setSize(d);
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        if (txtLLantaIzq2.getText().length() == 0 ) {
            JOptionPane.showMessageDialog(this, "Disculpe, Falta Informacion del Labrado en el Eje2 ");
            return;
        }
        String strLabrado = txtLLantaInz1.getText().concat("&").concat(txtLLantaIzq2.getText()).concat("$");        
        try {
        ...
        JOptionPane.showMessageDialog(this, "Se ha REGISTRADO la Profundidad de Labrado de una manera exitosa ..! ");
        this.dispose();       
        doClose(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProfundidadLabradoMoto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FrmProfundidadLabradoMoto dialog = new FrmProfundidadLabradoMoto(new javax.swing.JFrame(), true);
