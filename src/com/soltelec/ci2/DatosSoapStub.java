...
public class DatosSoapStub extends org.apache.axis.client.Stub implements com.soltelec.ci2.DatosSoap {
    ...
    static {
        ...
        urlServicio2 = "http://190.25.205.154:809?/sicov.asmx";
        _initOperationDesc1();
    }
    ...
    private static void _initOperationDesc1() {
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "fur"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tempuri.org/", "formulario"), com.soltelec.ci2.Formulario.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://tempuri.org/", "resultado"));
        oper.setReturnClass(com.soltelec.ci2.Resultado.class);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("http://tempuri.org/", "PIN"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://tempuri.org/", "pin"), com.soltelec.ci2.Pin.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://tempuri.org/", "resultado"));
        oper.setReturnClass(com.soltelec.ci2.Resultado.class);
    ...
    public DatosSoapStub() throws org.apache.axis.AxisFault {
        this(null);
    }

    public DatosSoapStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        this(service);
        super.cachedEndpoint = endpointURL;
    }

    public DatosSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        cls = com.soltelec.ci2.Formulario.class;
        ...
        cachedSerQNames.add(qName);
        cls = com.soltelec.ci2.Pin.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        cachedSerQNames.add(qName);
        cls = com.soltelec.ci2.Resultado.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
        ...
        cachedSerQNames.add(qName);
        cls = com.soltelec.ci2.FURRespuesta.class;
        cachedSerClasses.add(cls);
        cachedSerFactories.add(beansf);
        cachedDeserFactories.add(beandf);
    ...
    final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(DatosSoapStub.class);

    public com.soltelec.ci2.Resultado ingresarFur(com.soltelec.ci2.Formulario fur) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        try {
            java.lang.Object _resp = _call.invoke(new java.lang.Object[]{fur});
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                try {
                    ...
                    return (com.soltelec.ci2.Resultado) _resp;
                } catch (java.lang.Exception _exception) {
                    return (com.soltelec.ci2.Resultado) org.apache.axis.utils.JavaUtils.convert(_resp, com.soltelec.ci2.Resultado.class);
                }
            }
    ...
    public com.soltelec.ci2.FURRespuesta setFUR(java.lang.String cadena) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setUseSOAPAction(true);
        _call.setSOAPActionURI(urlServicio2.concat("/setFUR"));
       // _call.setSOAPActionURI(urlServicio2.concat("/_setFURParametrico"));  
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
       // _call.setOperationName(new javax.xml.namespace.QName(urlServicio2,"_setFURParametrico"));
        _call.setOperationName(new javax.xml.namespace.QName(urlServicio2, "setFUR"));
        setRequestHeaders(_call);
        setAttachments(_call);
        try {
            ...
            if (_resp instanceof java.rmi.RemoteException) {
                ...
                try {
                    ...
                    return (com.soltelec.ci2.FURRespuesta) _resp;
                } catch (java.lang.Exception _exception) {
                    return (com.soltelec.ci2.FURRespuesta) org.apache.axis.utils.JavaUtils.convert(_resp, com.soltelec.ci2.FURRespuesta.class);
                }
            }
        } catch (org.apache.axis.AxisFault axisFaultException) {
            throw axisFaultException;
    ...
    public com.soltelec.ci2.Resultado utilizarPin(com.soltelec.ci2.Pin PIN) throws java.rmi.RemoteException {
        ...
        setAttachments(_call);
        try {
            java.lang.Object _resp = _call.invoke(new java.lang.Object[]{PIN});
    ...
    public java.lang.String echo(java.lang.String dato) throws java.rmi.RemoteException {
        ...
        setAttachments(_call);
        try {
            java.lang.Object _resp = _call.invoke(new java.lang.Object[]{dato});
    ...
    public java.lang.String generico(java.lang.String array_parametros) throws java.rmi.RemoteException {
        ...
        setAttachments(_call);
        try {
            java.lang.Object _resp = _call.invoke(new java.lang.Object[]{array_parametros});
