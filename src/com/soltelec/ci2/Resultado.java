...
public class Resultado implements java.io.Serializable {
    ...
    public String toString() {
        return "Resultado{" + "fechaTransaccion=" + fechaTransaccion + ", horaTransaccion=" + horaTransaccion + ", codigoRespuesta=" + codigoRespuesta + ", mensajeRespuesta=" + mensajeRespuesta + ", confirmacion=" + confirmacion + '}';
    }
